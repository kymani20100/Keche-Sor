<div class="menu">                
            ...
            <ul class="navigation">            
                ...
                <li class="openable">
                    <a href="#">
                        <span class="isw-list"></span><span class="text">All Skills</span>
                    </a>
                    <ul>
                        <li>
                            <a href="#.">
                        ...
                        <li>
                            <a href="ajax-crud.php">
                                <span class="glyphicon glyphicon-chevron-right"></span><span class="text">Ajax Crud System</span>
                            </a>                  
                        </li> 
                        <li>
                            <a href="icons.html">
                ...
                <li class="openable">
                    ...
                    <ul>
                        <li>
                            <a href="user.html">
                                <span class="glyphicon glyphicon-info-sign"></span><span class="text">User info</span>
                            </a>                  
                        </li>
                        <li>
                            <a href="profile.html">
